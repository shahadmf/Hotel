...
public class RDesFamliy extends javax.swing.JFrame {

    
    public RDesFamliy() {
         super(" Family Room Description ");
        initComponents();
    ...
    private void initComponents() {
        ...
        destext.setText("Luxury Family rooms at H hotel feature a modern design and modern bathrooms with a shower cabin, and all offer free Wi-Fi, satellite TV with satellite channels and a work desk. Some rooms have an outdoor hot tub or private pool along side with roof top and beach view.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RDesFamliy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RDesFamliy().setVisible(true);
            }
        });
    }
